...
@router.message(Command(commands=['adding_file']), IsAdmin(), StateFilter(default_state))
...
async def process_adding_file_command(message: Message, state: FSMContext, task_number: int):
    try:
