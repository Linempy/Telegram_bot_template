...
LEXICON: dict[str, str] = {
    ...
    "поможет в подготовке к ЕГЭ по информатике 👨🏼‍💻. 'рассказать про подготовку'"
    ...
    "•<em>Практика</em>\n\nДля проверки своих знаний выполните команду /quick_test"
    ...
    "send_file": "Вот, держи материалы для подготовки. Нажми на кнопку <em>Назад</em>, чтобы вернуться к файлам",
    ...
    "get_task_text": "<b>Напишите условие задачи</b>",
    ...
    "quick_test": "<b>Вводная информация</b>\nТест состоит из 5 заданий "
